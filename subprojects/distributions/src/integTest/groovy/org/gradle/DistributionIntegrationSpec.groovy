...
abstract class DistributionIntegrationSpec extends AbstractIntegrationSpec {
    ...
    @Shared String version = new IntegrationTestBuildContext().distZipVersion.version
    ...
    protected TestFile getZip(String type = getDistributionLabel()) {
        new IntegrationTestBuildContext().distributionsDir.file("gradle-$baseVersion-${type}.zip")
    }
